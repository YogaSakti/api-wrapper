...
router.get("/tensorBids", asyncHandler(async (req, res, next) => {
    const successfulResult = await fetch("https://graphql.tensor.trade/graphql", {
        "headers": {
            "accept": "*/*",
    ...
    const json = await successfulResult.json();
